...
EnumType* EnumType::get(Context* context, ID id, UniqueString name) {
    return EnumType::getEnumType(context, id, name).get();
}

EnumType* EnumType::getBoundedRangeTypeType(Context* context) {
...
void EnumType::stringify(std::ostream& ss,
